...
public class TransportAPI  {
     ...
     */
    public void transports(final List items, final String tipus) {
        ...
        transportCall.enqueue(new Callback<Transport>() {
            ...
            public void onResponse(Response<Transport> response, Retrofit retrofit) {
                ...
                if(tipus.equals("bus") ){
                    items.addAll(data.getTmbs());
                } else if(tipus.equals("bicing")){
                    items.addAll(data.getBici());
                } else if (tipus.equals("metro")){
                    items.addAll(data.getMetro());
                }
            }
            ...
            public void onFailure(Throwable t) {
                Log.e("Update transports", Arrays.toString(t.getStackTrace()));
            }
        });
    }
}